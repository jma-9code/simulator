...
import com.mxgraph.examples.swing.editor.EditorActions.AcquisitionAction;
...
public class EditorPopupMenu extends JPopupMenu {
	...
	public EditorPopupMenu(BasicGraphEditor editor) {
		...
		add(editor
				.bind(mxResources.get("undo"), new HistoryAction(true), "/com/mxgraph/examples/swing/images/undo.gif"));
		...
		// add(editor.bind(mxResources.get("edit"),
		...
		add(editor.bind(mxResources.get("acquisition"), new AcquisitionAction())).setEnabled(oneSelected);
