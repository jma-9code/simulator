...
public class ComponentPanel extends JTabbedPane implements mxIEventListener, ListSelectionListener {
	...
	private JPanel initTab_detailPanel() {
		...
		layout.putConstraint(SpringLayout.NORTH, bt_help, 10, SpringLayout.SOUTH, valStrategy);
		layout.putConstraint(SpringLayout.WEST, bt_help, 10, SpringLayout.WEST, detailPanelTab);
		layout.putConstraint(SpringLayout.EAST, bt_help, -10, SpringLayout.EAST, detailPanelTab);
