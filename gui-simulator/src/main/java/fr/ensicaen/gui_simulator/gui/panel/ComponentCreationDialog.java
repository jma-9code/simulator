...
public class ComponentCreationDialog extends JDialog {
	...
	private SimulatorGUI editor;

	public ComponentCreationDialog(SimulatorGUI editor) {
		this.editor = editor;
		init();
	}
	...
	public void init() {
		...
		nameOfComponent = new JTextField("Default name");
		nameOfComponent.setPreferredSize(new Dimension(300, 22));
		...
		myLayout.putConstraint(SpringLayout.NORTH, label_formatOfComponent, 10, SpringLayout.SOUTH,
				label_nameOfComponent);
		...
		myLayout.putConstraint(SpringLayout.NORTH, label_typeOfComponent, 10, SpringLayout.SOUTH,
				label_formatOfComponent);
		...
		myLayout.putConstraint(SpringLayout.NORTH, checkbox_inoutComponent, 00, SpringLayout.NORTH,
				label_typeOfComponent);
		...
		myLayout.putConstraint(SpringLayout.EAST, cancel, 20, SpringLayout.HORIZONTAL_CENTER, getContentPane());

		myLayout.putConstraint(SpringLayout.NORTH, create, 10, SpringLayout.SOUTH, checkbox_inoutComponent);
		myLayout.putConstraint(SpringLayout.WEST, create, 20, SpringLayout.HORIZONTAL_CENTER, getContentPane());
