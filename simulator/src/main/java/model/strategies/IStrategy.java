...
public interface IStrategy<T extends Component> {
	...
	// 
	// On modifierai ensuite le simulateur afin que les points de démarrage soit des évènements
	// et non une données dans un input. Ex : J'insère ma carte sur le composant TPE.
