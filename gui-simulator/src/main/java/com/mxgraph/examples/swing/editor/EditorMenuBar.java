...
public class EditorMenuBar extends JMenuBar {
	...
	public EditorMenuBar(final BasicGraphEditor editor) {
		...
		// menu.add(editor.bind(mxResources.get("importStencil"), new
		// ImportAction(),
		// "/com/mxgraph/examples/swing/images/open.gif"));
		...
		// menu.add(editor.bind(mxResources.get("pageSetup"), new
		// PageSetupAction(),
		...
		//
		// menu.add(editor.bind(mxResources.get("undo"), new
		// HistoryAction(true),
		// "/com/mxgraph/examples/swing/images/undo.gif"));
		// menu.add(editor.bind(mxResources.get("redo"), new
		// HistoryAction(false),
		...
		// menu.addSeparator();
		//
		// menu.add(editor.bind(mxResources.get("warning"), new
		// WarningAction()));
		...
		// mxResources.get("pageLayout"), "PageVisible",
		...
		// menu.addSeparator();
		//
		// menu.add(editor.bind(mxResources.get("page"), new
		// ZoomPolicyAction(mxGraphComponent.ZOOM_POLICY_PAGE)));
		// menu.add(editor.bind(mxResources.get("width"), new
		// ZoomPolicyAction(mxGraphComponent.ZOOM_POLICY_WIDTH)));
		//
		// menu.addSeparator();
		//
		...
		// mxResources.get("buffering"), "TripleBuffered", true));
		//
		// submenu.add(new TogglePropertyItem(graphComponent,
		// mxResources.get("preferPageSize"), "PreferPageSize", true,
		// new ActionListener() {
		// /**
		// *
		// */
		...
		// submenu.addSeparator();
		//
		// submenu.add(editor.bind(mxResources.get("tolerance"), new
		// PromptPropertyAction(graphComponent, "Tolerance")));
		//
		// submenu.add(editor.bind(mxResources.get("dirty"), new
		// ToggleDirtyAction()));
		//
		// submenu = (JMenu) menu.add(new JMenu(mxResources.get("zoom")));
		//
		// submenu.add(new TogglePropertyItem(graphComponent,
		// mxResources.get("centerZoom"), "CenterZoom", true));
		// submenu.add(new TogglePropertyItem(graphComponent,
		...
		//
		// submenu.add(new TogglePropertyItem(graphComponent,
		// mxResources.get("centerPage"), "CenterPage", true,
		// new ActionListener() {
		// /**
		// *
		// */
		...
		//
		// submenu.add(new TogglePropertyItem(graphComponent,
		// mxResources.get("dragEnabled"), "DragEnabled"));
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("dropEnabled"), "DropEnabled"));
		//
		// submenu.addSeparator();
		//
		// submenu.add(new TogglePropertyItem(graphComponent.getGraphHandler(),
		// mxResources.get("imagePreview"),
		// "ImagePreview"));
		//
		...
		//
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("moveEdgeLabels"), "EdgeLabelsMovable"));
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("moveVertexLabels"), "VertexLabelsMovable"));
		//
		// submenu.addSeparator();
		//
		// submenu.add(new TogglePropertyItem(graphComponent,
		...
		//
		// submenu = (JMenu) menu.add(new
		// JMenu(mxResources.get("connections")));
		//
		// submenu.add(new TogglePropertyItem(graphComponent,
		// mxResources.get("connectable"), "Connectable"));
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("connectableEdges"), "ConnectableEdges"));
		//
		// submenu.addSeparator();
		//
		// submenu.add(new ToggleCreateTargetItem(editor,
		// mxResources.get("createTarget")));
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("disconnectOnMove"), "DisconnectOnMove"));
		//
		// submenu.addSeparator();
		//
		// submenu.add(editor.bind(mxResources.get("connectMode"), new
		// ToggleConnectModeAction()));
		//
		// submenu = (JMenu) menu.add(new JMenu(mxResources.get("validation")));
		//
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("allowDanglingEdges"), "AllowDanglingEdges"));
		// submenu.add(new TogglePropertyItem(graph,
		// mxResources.get("cloneInvalidEdges"), "CloneInvalidEdges"));
		//
		// submenu.addSeparator();
		//
		// submenu.add(new TogglePropertyItem(graph,
		...
		// aGraph)));
		// menu.add(editor.bind("Complete Graph", new
		// InsertGraph(GraphType.COMPLETE, aGraph)));
		// menu.add(editor.bind("Grid", new InsertGraph(GraphType.GRID,
		// aGraph)));
		// menu.add(editor.bind("Bipartite", new
		// InsertGraph(GraphType.BIPARTITE, aGraph)));
		// menu.add(editor.bind("Complete Bipartite", new
		// InsertGraph(GraphType.COMPLETE_BIPARTITE, aGraph)));
		// menu.add(editor.bind("Knight's Graph", new
		// InsertGraph(GraphType.KNIGHT, aGraph)));
		...
		// aGraph)));
		// menu.add(editor.bind("Friendship Windmill", new
		// InsertGraph(GraphType.FRIENDSHIP_WINDMILL, aGraph)));
		// menu.add(editor.bind("Full Windmill", new
		// InsertGraph(GraphType.FULL_WINDMILL, aGraph)));
		// menu.add(editor.bind("Knight's Tour", new
		// InsertGraph(GraphType.KNIGHT_TOUR, aGraph)));
		// menu.addSeparator();
		// menu.add(editor.bind("Simple Random", new
		// InsertGraph(GraphType.SIMPLE_RANDOM, aGraph)));
		// menu.add(editor.bind("Simple Random Tree", new
		// InsertGraph(GraphType.SIMPLE_RANDOM_TREE, aGraph)));
		// menu.addSeparator();
		// menu.add(editor.bind("Reset Style", new
		// InsertGraph(GraphType.RESET_STYLE, aGraph)));
		//
		// menu = add(new JMenu("Analyze"));
		// menu.add(editor.bind("Is Connected", new
		// AnalyzeGraph(AnalyzeType.IS_CONNECTED, aGraph)));
		// menu.add(editor.bind("Is Simple", new
		// AnalyzeGraph(AnalyzeType.IS_SIMPLE, aGraph)));
		// menu.add(editor.bind("Is Directed Cyclic", new
		// AnalyzeGraph(AnalyzeType.IS_CYCLIC_DIRECTED, aGraph)));
		// menu.add(editor.bind("Is Undirected Cyclic", new
		// AnalyzeGraph(AnalyzeType.IS_CYCLIC_UNDIRECTED, aGraph)));
		// menu.add(editor.bind("BFS Directed", new
		// InsertGraph(GraphType.BFS_DIR, aGraph)));
		// menu.add(editor.bind("BFS Undirected", new
		// InsertGraph(GraphType.BFS_UNDIR, aGraph)));
		// menu.add(editor.bind("DFS Directed", new
		// InsertGraph(GraphType.DFS_DIR, aGraph)));
		// menu.add(editor.bind("DFS Undirected", new
		// InsertGraph(GraphType.DFS_UNDIR, aGraph)));
		// menu.add(editor.bind("Complementary", new
		// AnalyzeGraph(AnalyzeType.COMPLEMENTARY, aGraph)));
		// menu.add(editor.bind("Regularity", new
		// AnalyzeGraph(AnalyzeType.REGULARITY, aGraph)));
		// menu.add(editor.bind("Dijkstra", new InsertGraph(GraphType.DIJKSTRA,
		// aGraph)));
		// menu.add(editor.bind("Bellman-Ford", new
		// InsertGraph(GraphType.BELLMAN_FORD, aGraph)));
		// menu.add(editor.bind("Floyd-Roy-Warshall", new
		// AnalyzeGraph(AnalyzeType.FLOYD_ROY_WARSHALL, aGraph)));
		// menu.add(editor.bind("Get Components", new
		// AnalyzeGraph(AnalyzeType.COMPONENTS, aGraph)));
		// menu.add(editor.bind("Make Connected", new
		// AnalyzeGraph(AnalyzeType.MAKE_CONNECTED, aGraph)));
		// menu.add(editor.bind("Make Simple", new
		// AnalyzeGraph(AnalyzeType.MAKE_SIMPLE, aGraph)));
		// menu.add(editor.bind("Is Tree", new AnalyzeGraph(AnalyzeType.IS_TREE,
		// aGraph)));
		// menu.add(editor.bind("One Spanning Tree", new
		// AnalyzeGraph(AnalyzeType.ONE_SPANNING_TREE, aGraph)));
		// menu.add(editor.bind("Make tree directed", new
		// InsertGraph(GraphType.MAKE_TREE_DIRECTED, aGraph)));
		// menu.add(editor.bind("Is directed", new
		// AnalyzeGraph(AnalyzeType.IS_DIRECTED, aGraph)));
		// menu.add(editor.bind("Indegree", new InsertGraph(GraphType.INDEGREE,
		// aGraph)));
		// menu.add(editor.bind("Outdegree", new
		// InsertGraph(GraphType.OUTDEGREE, aGraph)));
		// menu.add(editor.bind("Is cut vertex", new
		// InsertGraph(GraphType.IS_CUT_VERTEX, aGraph)));
		// menu.add(editor.bind("Get cut vertices", new
		// AnalyzeGraph(AnalyzeType.GET_CUT_VERTEXES, aGraph)));
		// menu.add(editor.bind("Get cut edges", new
		// AnalyzeGraph(AnalyzeType.GET_CUT_EDGES, aGraph)));
		// menu.add(editor.bind("Get sources", new
		// AnalyzeGraph(AnalyzeType.GET_SOURCES, aGraph)));
		// menu.add(editor.bind("Get sinks", new
		// AnalyzeGraph(AnalyzeType.GET_SINKS, aGraph)));
		// menu.add(editor.bind("Is biconnected", new
		// AnalyzeGraph(AnalyzeType.IS_BICONNECTED, aGraph)));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor) {
		...
		submenu.add(editor.bind(mxResources.get("fillcolor"),
				new ColorAction("Fillcolor", mxConstants.STYLE_FILLCOLOR),
		...
		submenu.add(editor.bind(mxResources.get("opacity"), new PromptValueAction(mxConstants.STYLE_OPACITY,
				"Opacity (0-100)")));

		submenu = (JMenu) menu.add(new JMenu(mxResources.get("label")));

		submenu.add(editor.bind(mxResources.get("fontcolor"),
				new ColorAction("Fontcolor", mxConstants.STYLE_FONTCOLOR),
		...
		submenu.add(editor.bind(mxResources.get("textOpacity"), new PromptValueAction(mxConstants.STYLE_TEXT_OPACITY,
				"Opacity (0-100)")));
		...
		subsubmenu.add(editor.bind(mxResources.get("top"), new SetLabelPositionAction(mxConstants.ALIGN_TOP,
				mxConstants.ALIGN_BOTTOM)));
		subsubmenu.add(editor.bind(mxResources.get("middle"), new SetLabelPositionAction(mxConstants.ALIGN_MIDDLE,
				mxConstants.ALIGN_MIDDLE)));
		subsubmenu.add(editor.bind(mxResources.get("bottom"), new SetLabelPositionAction(mxConstants.ALIGN_BOTTOM,
				mxConstants.ALIGN_TOP)));

		subsubmenu.addSeparator();

		subsubmenu.add(editor.bind(mxResources.get("left"), new SetLabelPositionAction(mxConstants.ALIGN_LEFT,
				mxConstants.ALIGN_RIGHT)));
		subsubmenu.add(editor.bind(mxResources.get("center"), new SetLabelPositionAction(mxConstants.ALIGN_CENTER,
				mxConstants.ALIGN_CENTER)));
		subsubmenu.add(editor.bind(mxResources.get("right"), new SetLabelPositionAction(mxConstants.ALIGN_RIGHT,
		...
		submenu.add(editor.bind(mxResources.get("linewidth"), new PromptValueAction(mxConstants.STYLE_STROKEWIDTH,
				"Linewidth")));
		...
		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction(
				"edgeStyle=mxEdgeStyle.EntityRelation"), "/com/mxgraph/examples/swing/images/entity.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_STARTARROW,
				mxConstants.ARROW_OPEN), "/com/mxgraph/examples/swing/images/open_start.gif"));
		submenu.add(editor.bind(mxResources.get("classic"), new KeyValueAction(mxConstants.STYLE_STARTARROW,
				mxConstants.ARROW_CLASSIC), "/com/mxgraph/examples/swing/images/classic_start.gif"));
		submenu.add(editor.bind(mxResources.get("block"), new KeyValueAction(mxConstants.STYLE_STARTARROW,
				mxConstants.ARROW_BLOCK), "/com/mxgraph/examples/swing/images/block_start.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("diamond"), new KeyValueAction(mxConstants.STYLE_STARTARROW,
				mxConstants.ARROW_DIAMOND), "/com/mxgraph/examples/swing/images/diamond_start.gif"));
		submenu.add(editor.bind(mxResources.get("oval"), new KeyValueAction(mxConstants.STYLE_STARTARROW,
				mxConstants.ARROW_OVAL), "/com/mxgraph/examples/swing/images/oval_start.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("none"), new KeyValueAction(mxConstants.STYLE_STARTARROW,
				mxConstants.NONE)));
		submenu.add(editor.bind(mxResources.get("size"), new PromptValueAction(mxConstants.STYLE_STARTSIZE,
				"Linestart Size")));

		submenu = (JMenu) menu.add(new JMenu(mxResources.get("lineend")));

		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_ENDARROW,
				mxConstants.ARROW_OPEN), "/com/mxgraph/examples/swing/images/open_end.gif"));
		submenu.add(editor.bind(mxResources.get("classic"), new KeyValueAction(mxConstants.STYLE_ENDARROW,
				mxConstants.ARROW_CLASSIC), "/com/mxgraph/examples/swing/images/classic_end.gif"));
		submenu.add(editor.bind(mxResources.get("block"), new KeyValueAction(mxConstants.STYLE_ENDARROW,
				mxConstants.ARROW_BLOCK), "/com/mxgraph/examples/swing/images/block_end.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("diamond"), new KeyValueAction(mxConstants.STYLE_ENDARROW,
				mxConstants.ARROW_DIAMOND), "/com/mxgraph/examples/swing/images/diamond_end.gif"));
		submenu.add(editor.bind(mxResources.get("oval"), new KeyValueAction(mxConstants.STYLE_ENDARROW,
				mxConstants.ARROW_OVAL), "/com/mxgraph/examples/swing/images/oval_end.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("none"), new KeyValueAction(mxConstants.STYLE_ENDARROW,
				mxConstants.NONE)));
		submenu.add(editor.bind(mxResources.get("size"), new PromptValueAction(mxConstants.STYLE_ENDSIZE,
				"Lineend Size")));
		...
		submenu.add(editor.bind(mxResources.get("left"), new KeyValueAction(mxConstants.STYLE_ALIGN,
				mxConstants.ALIGN_LEFT), "/com/mxgraph/examples/swing/images/left.gif"));
		submenu.add(editor.bind(mxResources.get("center"), new KeyValueAction(mxConstants.STYLE_ALIGN,
				mxConstants.ALIGN_CENTER), "/com/mxgraph/examples/swing/images/center.gif"));
		submenu.add(editor.bind(mxResources.get("right"), new KeyValueAction(mxConstants.STYLE_ALIGN,
				mxConstants.ALIGN_RIGHT), "/com/mxgraph/examples/swing/images/right.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("top"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN,
				mxConstants.ALIGN_TOP), "/com/mxgraph/examples/swing/images/top.gif"));
		submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN,
				mxConstants.ALIGN_MIDDLE), "/com/mxgraph/examples/swing/images/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN,
				mxConstants.ALIGN_BOTTOM), "/com/mxgraph/examples/swing/images/bottom.gif"));

		submenu = (JMenu) menu.add(new JMenu(mxResources.get("spacing")));

		submenu.add(editor.bind(mxResources.get("top"), new PromptValueAction(mxConstants.STYLE_SPACING_TOP,
				"Top Spacing")));
		submenu.add(editor.bind(mxResources.get("right"), new PromptValueAction(mxConstants.STYLE_SPACING_RIGHT,
				"Right Spacing")));
		submenu.add(editor.bind(mxResources.get("bottom"), new PromptValueAction(mxConstants.STYLE_SPACING_BOTTOM,
				"Bottom Spacing")));
		submenu.add(editor.bind(mxResources.get("left"), new PromptValueAction(mxConstants.STYLE_SPACING_LEFT,
				"Left Spacing")));
		...
		submenu.add(editor.bind(mxResources.get("north"), new KeyValueAction(mxConstants.STYLE_DIRECTION,
				mxConstants.DIRECTION_NORTH)));
		submenu.add(editor.bind(mxResources.get("east"), new KeyValueAction(mxConstants.STYLE_DIRECTION,
				mxConstants.DIRECTION_EAST)));
		submenu.add(editor.bind(mxResources.get("south"), new KeyValueAction(mxConstants.STYLE_DIRECTION,
				mxConstants.DIRECTION_SOUTH)));
		submenu.add(editor.bind(mxResources.get("west"), new KeyValueAction(mxConstants.STYLE_DIRECTION,
				mxConstants.DIRECTION_WEST)));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("rotation"), new PromptValueAction(mxConstants.STYLE_ROTATION,
				"Rotation (0-360)")));
